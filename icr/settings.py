"""
Django settings for icr project.
...
SECRET_KEY = (
    "django-insecure-)#qz*os981-@6@$uoo98%+3d4x$j6&1c%wjtx*)p4m$gyw06ad"
)
...
WSGI_APPLICATION = "icr.wsgi.application"
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, "icr/static/")]
